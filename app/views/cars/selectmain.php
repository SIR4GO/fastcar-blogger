...
<div class="body">
    ...
    <?php  for($i = count($this->arr_title) - 1 ; $i >=  0  ; $i-- )  { ?>
        ...
        <div class="box">
            ...
            <div class="content">
                <a style="color: black ; text-decoration: none" href="/cars/select/<?= $this->arr_pages[$i] ?>">   <h2 class=" h2 title"> <?= $this->arr_title[$i] ?>     </h2> </a>

                <p class="lead" >
                    <a style="color:#345366 ; text-decoration: none" href="/cars/select/<?= $this->arr_pages[$i] ?>"> <?= $this->arr_summary[$i] ?> </a>
                </p>
            </div>
        </div>
    <?php } ?>
